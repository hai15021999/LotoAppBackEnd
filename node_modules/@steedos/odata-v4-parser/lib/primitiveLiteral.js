...
(function (PrimitiveLiteral) {
    ...
    function arrayValue(value, index) {
        ...
        if (squote) {
            index = squote;
            while (index < value.length) {
                squote = lexer_1.default.CLOSE(value, index);
                if (squote) {
                    index = squote;
            ...
            return lexer_1.default.tokenize(value, start, index, "Edm.Array", lexer_1.default.TokenType.Literal);
        }
    }
    PrimitiveLiteral.arrayValue = arrayValue;
